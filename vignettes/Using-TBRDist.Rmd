...
TBRDist is a package to compare phylogenetic trees.
...
* Chris Whidden and Frederick A. Matsen IV (2017). Calculating the Unrooted Subtree-Prune-and-Regraft Distance. eprint arXiv:[1511.07529](http://arxiv.org/abs/1511.07529).

Optionally, a citation to the TBRDist package would be welcome:

* Smith (2019). TBRDist: Calculate SPR and TBR distance between unrooted phylogenetic treess. doi:[10.5281/zenodo.3548333](https://dx.doi.org/10.5281/zenodo.3548333)
